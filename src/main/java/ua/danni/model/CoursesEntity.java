...
public class CoursesEntity {
    ...
    private String end;
    private UserEntity userByIdProfessor;
    ...
    public UserEntity getUserByIdProfessor() {
        return userByIdProfessor;
    }

    public void setUserByIdProfessor(UserEntity userByIdProfessor) {
